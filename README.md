...
* **Modes:**
    ...
    * `TO`: Teleoperation - velocity control using the Jacobian Matrix ($J^{-1} \cdot v$). Includes **Singularity Avoidance** and **Z-limit Protection**.
    * `AT/AM`: Auto Mode - requests random poses and moves automatically with 10-second intervals.
...
| `/singularity_warning` | String | Singularity/limit alert message |
